...
class CreateUserRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'phone_number' => 'required|numeric|digits_between:1,50|unique:users,phone_number',
            ...
            'country_code' => 'required|max:2|exists:country,country_code',
            'enrollment_source_code' => 'required|max:20|exists:enrollment_bonus,source_code', 
            'referring_member_id' => 'numeric|max:50', 
